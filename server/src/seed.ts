...
async function seed() {
	for (let index = 0; index < posts.length; index++) {
		...
		db.query(
			`INSERT INTO ${postsTable} (title, content, image) VALUES('${element.title}', '${element.content}', '${element.image}');`,
			(error: any) => {
