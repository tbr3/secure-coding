...
const CommentForm: FC = (props) => {
    ...
    const handleSubmit = useCallback((e: React.FormEvent<HTMLFormElement>) => {
        ...
        fetch(`/api/posts/${state.postId}/comments`, { method: 'POST', body: JSON.stringify(comment), headers: { 'Content-Type': 'application/json' } })
            .then(() => {
    ...
    if (state.submissionState === CommentFormSubmissionState.SUBMITTED) return (
